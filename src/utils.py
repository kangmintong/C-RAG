...
def get_path_calibration_output(args, llm_model_id, model_id, task_name):
    return '{}/{}_{}/{}_{}_{}_{}_calibration_result.json'.format(args.output_dir, llm_model_id, model_id, task_name, args.llm_k_shot, args.llm_num_gen, args.llm_gen_threshold)

def get_path_simulation_output(args, llm_model_id, model_id, task_name):
    return '{}/{}_{}/{}_{}_{}_{}_simulation_result.json'.format(args.output_dir, llm_model_id, model_id, task_name, args.llm_k_shot, args.llm_num_gen, args.llm_gen_threshold)

def get_path_conformal_guarantee_res(args, llm_model_id, model_id, task_name):
    return 'results/{}_{}/{}_{}_{}_{}_conformal_guarantee.json'.format(llm_model_id, model_id, task_name, args.llm_k_shot, args.llm_num_gen, args.llm_gen_threshold)
